...
* **Live Application Link:** [https://autohealops-frontend.onrender.com/](https://autohealops-frontend.onrender.com/)
...
* **Backend:** A containerized **Python API** handling telemetry streaming data, anomaly interception loops, and automated process recovery routines.
* **Database:** Hosted on a cloud-native **MongoDB Atlas** cluster managing state configurations, environment tracking, and historical error logs.

---

## 🛠️ Key Features

* **Real-Time Telemetry:** Continuous reporting of cluster performance metrics (CPU load, memory allocation) via streaming dashboard metrics.
...
3. **Detection & Restoration:** The automated remediation loop catches the failure signature, triggers the custom recovery script, isolates container processes, and spins up fresh fallback microservice instances.
